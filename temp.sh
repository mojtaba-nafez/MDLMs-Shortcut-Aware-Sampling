...
# bash temp.sh --revise_step false --remove_self_attn false --mask_embedding_blending false
...
checkpoint_path=/home/nafez/scratch/remdm-shortcut-removal/weights/sedd.ckpt

T=0
sampling_steps=1024
p=0.9
generated_seqs_path=/home/nafez/scratch/remdm-shortcut-removal/outputs/our-sedd_revise_step_${revise_step}_remove_self_attn_${remove_self_attn}_mask_embedding_blending_${mask_embedding_blending}_T-${sampling_steps}_topp-${p}.json
